...
export default {
  ...
  beforeCreate({ config }) {
    ...
    // Result: https://res.cloudinary.com/xyz/image/fetch/f_jpg,q_auto/https://raw.github.../images
    config.imageSource = `https://res.cloudinary.com/${cloudName}/image/fetch/f_jpg,q_auto/${githubRepo}`;
  },
